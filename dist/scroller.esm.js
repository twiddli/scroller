...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function getValues() {
      return {
        left: this.__scrollLeft - (this.options.centering ? this.__leftOffset : 0),
        top: this.__scrollTop - (this.options.centering ? this.__topOffset : 0),
    ...
    value: function zoomTo(level, animate, originLeft, originTop, callback) {
      ...
      var oldLevel = this.__zoomLevel; // Limit level according to configuration

      level = Math.max(Math.min(level, this.options.maxZoom), this.options.minZoom); // Normalize input origin to center of viewport if not defined
      ...
      if (animate && this.options.animating) {
        ...
        var step = function step(percent, now, render) {
          if (render) {
            ...
            if (_this.__callback) {
              _this.__callback(_this.__scrollLeft - _this.__leftOffset, _this.__scrollTop - _this.__topOffset, _this.__zoomLevel);
            }
          }
        };

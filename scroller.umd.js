    ...
    start: function start(stepCallback, verifyCallback, completedCallback, duration, easingMethod, root) {
      ...
      var step = function step(virtual) {
        ...
        if (!running[id] || verifyCallback && !verifyCallback(id)) {
          running[id] = null; // eslint-disable-next-line no-unused-expressions
      ...
      Animate.requestAnimationFrame(step, root); // Return unique animation ID
    ...
    __stepThroughDeceleration: function __stepThroughDeceleration(render) {
      ...
      if (self.options.bouncing) {
        ...
        var _self$options = self.options,
            penetrationDeceleration = _self$options.penetrationDeceleration,
            penetrationAcceleration = _self$options.penetrationAcceleration; // Check limits
